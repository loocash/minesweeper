...
var _Minesweeper = __webpack_require__(6);
...
var MinesweeperUI = function () {
  ...
  var Elements = _.mapValues({
    table: "#minesweeper .board",
    highScores: "#minesweeper .high-scores",
  ...
  Elements.td = (0, _UIUtils.makeTdElements)(_Minesweeper.SIZE);

  var timer = new _Timer2.default(function (elapsed) {
    Elements.timer.innerText = elapsed;
  });

  var game = new _Minesweeper2.default({
    timer: timer
  });

  var draw = function draw() {
    Elements.td.forEach(function (td, i) {
      td.className = "";
      td.innerText = "";
    });
    Elements.flagCounter.innerText = game.flags;
    Elements.td.forEach(function (td, i) {
      var field = game.getTile(i);
      if (field.isRevealed) {
  ...
  var addEventListeners = function addEventListeners() {
    ...
    table.addEventListener("click", function (_ref) {
      ...
      if (target.tagName.toLowerCase() === "td") {
        var tile = target.getAttribute("data-tile");
  ...
  var init = function init() {
    (0, _UIUtils.makeTable)(Elements.table, Elements.td, _Minesweeper.SIDE);
    addEventListeners();
    draw();
  };
...
var _MinesweeperUI = __webpack_require__(1);

var _MinesweeperUI2 = _interopRequireDefault(_MinesweeperUI);

__webpack_require__(2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_MinesweeperUI2.default.init();
...
var BFS = function () {
  ...
  var from = function from(sourceNode, neighbors) {
    var queue = [sourceNode];
    var result = [];
    sourceNode.visited = true;
    while (!_lodash2.default.isEmpty(queue)) {
      var node = queue.shift();
      result.push(node);
      var unvisitedNeighbors = neighbors.call(_this, node).filter(function (n) {
        return !n.visited;
      });
      unvisitedNeighbors.forEach(function (n) {
        return n.visited = true;
      });
      queue.push.apply(queue, _toConsumableArray(unvisitedNeighbors));
    }
    return result;
  };
...
var Grid = function () {
  ...
  _createClass(Grid, [{
    ...
    value: function inBounds(row, col) {
      return _lodash2.default.inRange(row, this.rows) && _lodash2.default.inRange(col, this.cols);
    }
    ...
    key: 'cellToIndex',
    value: function cellToIndex(row, col) {
    ...
    key: 'indexToCell',
    value: function indexToCell(index) {
    ...
    value: function getCell(row, col) {
      ...
      var index = this.cellToIndex(row, col);
    ...
    key: 'setCell',
    value: function setCell(row, col, element) {
      if (this.inBounds(row, col)) {
        var index = this.cellToIndex(row, col);
    ...
    value: function toString() {
      ...
      return _lodash2.default.chain(this.getCells()).chunk(this.cols).map(function (rowCells) {
        return rowCells.map(function (_ref) {
          var _ref2 = _slicedToArray(_ref, 2);

          var row = _ref2[0];
          var col = _ref2[1];
          return _this.getCell(row, col);
        }).join(' ');
      }).join('\n').value();
    }
    ...
    key: 'isAdjacent',
    value: function isAdjacent(rowA, colA, rowB, colB) {
    ...
    key: 'getAdjacent',
    value: function getAdjacent(row, col) {
      var _this2 = this;
      ...
      return vectors.map(function (_ref3) {
        ...
        var row = _ref6[0];
        var col = _ref6[1];
        return _this2.inBounds(row, col);
      });
    }
    ...
    key: 'areNeighbors',
    value: function areNeighbors(rowA, colA, rowB, colB) {
    ...
    key: 'swap',
    value: function swap(rowA, colA, rowB, colB) {
      var cellA = [rowA, colA];
      var cellB = [rowB, colB];
      if (this.inBounds.apply(this, cellA) && this.inBounds.apply(this, cellB)) {
        var tmpCell = this.getCell.apply(this, cellA);
        this.setCell.apply(this, cellA.concat([this.getCell.apply(this, cellB)]));
        this.setCell.apply(this, cellB.concat([tmpCell]));
      }
    }
    ...
    value: function find(predicate) {
      var index = this.array.findIndex(predicate);
      if (index === -1) {
        return null;
      }
    ...
    value: function filter(predicate) {
      ...
      return this.getCells().filter(function (_ref7) {
        var _ref8 = _slicedToArray(_ref7, 2);

        var row = _ref8[0];
        var col = _ref8[1];
        return predicate.call(_this3, _this3.getCell(row, col));
      });
    }
    ...
    value: function getNeighbors(row, col) {
      ...
      for (var dx = -1; dx < 2; ++dx) {
        for (var dy = -1; dy < 2; ++dy) {
          if (dx !== 0 || dy !== 0) {
            var cell = [row + dx, col + dy];
            if (this.inBounds.apply(this, cell)) {
              result.push(cell);
            }
          }
        }
...
exports.BOMBS = exports.SIZE = exports.SIDE = exports.Field = exports.Minesweeper = undefined;
...
var Field = function () {
   ...
   */
  function Field() {
    var hasBomb = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
    var bombsAround = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
  ...
  _createClass(Field, [{
    ...
    value: function toString() {
      if (this.isRevealed) {
        if (this.hasBomb) return "*";else if (this.bombsAround > 0) return this.bombsAround;else return ".";
      } else {
...
var Minesweeper = function () {
  ...
  function Minesweeper(_ref) {
    var onHighScore = _ref.onHighScore;
  ...
  _createClass(Minesweeper, [{
    key: 'init',
    value: function init() {
      this.grid = new _Grid2.default(SIDE, SIDE, Minesweeper.makeFields());
    ...
    key: 'bfs_init',
    value: function bfs_init() {
      var _this = this;

      var grid = this.grid;

      var Node = function Node(value, row, col) {
        this.value = value;
        this.row = row;
        this.col = col;
        this.visited = false;
      ...
      _lodash2.default.times(SIDE, function (row) {
        _lodash2.default.times(SIDE, function (col) {
          var node = new Node(_this.grid.getCell(row, col), row, col);
      ...
      this.neighbors = function (node) {
        ...
        if (field.bombsAround === 0 && !field.hasBomb && !field.isFlagged()) {
          return _this.nodes.filter(function (n) {
            return n.isNeighbor(node);
          });
        } else if (field.hasBomb) {
          return _this.nodes.filter(function (n) {
            return n.value.hasBomb;
          });
        }
        return [];
      };
    ...
    value: function mark(row, col) {
      if (this.grid.inBounds(row, col) && !this.isSolved()) {
        var field = this.grid.getCell(row, col);
        if (field.isFlagged()) {
          this.flags--;
        }
        field.changeMark();
    ...
    value: function markTile(tile) {
      var cell = this.grid.indexToCell(tile);
      this.mark.apply(this, _toConsumableArray(cell));
    }
  }, {
    key: 'reveal',
    value: function reveal(row, col) {
      var _this2 = this;
      ...
      if (this.grid.inBounds(row, col) && !this.isSolved()) {
        ...
        if (!field.isRevealed && !field.isFlagged()) {
          var sourceCell = this.nodes.find(function (c) {
            return c.row === row && c.col === col;
          });
          var cellsToReveal = _BFS2.default.from(sourceCell, this.neighbors);
          cellsToReveal.forEach(function (c) {
            return c.value.reveal();
          });
        } else if (field.isRevealed && field.bombsAround > 0) {
          var unrevealed = this.grid.getNeighbors(row, col).filter(function (cell) {
            var _grid;

            return !(_grid = _this2.grid).getCell.apply(_grid, _toConsumableArray(cell)).isRevealed;
          });
          var flagsAround = unrevealed.filter(function (cell) {
            var _grid2;

            return (_grid2 = _this2.grid).getCell.apply(_grid2, _toConsumableArray(cell)).isFlagged();
          }).length;
          if (flagsAround >= field.bombsAround) {
            unrevealed.forEach(function (cell) {
              return _this2.reveal.apply(_this2, _toConsumableArray(cell));
            });
          }
        }
        if (this.isSolved()) {
    ...
    value: function revealTile(tile) {
      var cell = this.grid.indexToCell(tile);
      this.reveal.apply(this, _toConsumableArray(cell));
    }
  }, {
    key: 'isLost',
    value: function isLost() {
      return this.grid.array.some(function (field) {
        return field.isRevealed && field.hasBomb;
      });
    }
  }, {
    key: 'isWon',
    value: function isWon() {
      return this.grid.array.every(function (field) {
        return field.isRevealed && !field.hasBomb || !field.isRevealed && field.hasBomb;
      });
    }
  }, {
    key: 'isSolved',
    ...
    value: function getTile(tile) {
      ...
      var cell = this.grid.indexToCell(tile);
      return (_grid3 = this.grid).getCell.apply(_grid3, _toConsumableArray(cell));
    }
  }, {
    key: 'toString',
    value: function toString() {
    ...
    value: function makeFields() {
      var clearFields = _lodash2.default.range(SIZE - BOMBS).map(function (i) {
        return new Field();
      });
      var bombedFields = _lodash2.default.range(BOMBS).map(function (i) {
        return new Field(true);
      });
      var fields = _lodash2.default.shuffle(clearFields.concat(bombedFields));
      return fields;
    }
  }, {
    key: 'countBombs',
    value: function countBombs(grid) {
      grid.getCells().forEach(function (cell) {
        var field = grid.getCell.apply(grid, _toConsumableArray(cell));
        var neighbors = grid.getNeighbors.apply(grid, _toConsumableArray(cell));
        var bombedNeighbors = neighbors.filter(function (n) {
          return grid.getCell.apply(grid, _toConsumableArray(n)).hasBomb;
        });
...
exports.makeTdElements = exports.makeTable = undefined;
 ...
 */
var makeTable = function makeTable(table, tdElements, side) {
  for (var row = 0; row < side; row++) {
    var tr = document.createElement("tr");
    for (var col = 0; col < side; col++) {
      var tile = row * side + col;
      var td = tdElements[tile];
      tr.appendChild(td);
    }
...
var makeTdElements = function makeTdElements(size) {
  return _lodash2.default.range(size).map(function (i) {
...
exports.makeTdElements = makeTdElements;
...
// module
exports.push([module.i, "/* html5reset.css - 01/11/2011 */\nhtml, body, div, span, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\nabbr, address, cite, code,\ndel, dfn, em, img, ins, kbd, q, samp,\nsmall, strong, sub, sup, var,\nb, i,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  outline: 0;\n  font-size: 100%;\n  vertical-align: baseline;\n  background: transparent; }\n\nbody {\n  line-height: 1; }\n\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n  display: block; }\n\nnav ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: '';\n  content: none; }\n\na {\n  margin: 0;\n  padding: 0;\n  font-size: 100%;\n  vertical-align: baseline;\n  background: transparent; }\n\n/* change colours to suit your needs */\nins {\n  background-color: #ff9;\n  color: #000;\n  text-decoration: none; }\n\n/* change colours to suit your needs */\nmark {\n  background-color: #ff9;\n  color: #000;\n  font-style: italic;\n  font-weight: bold; }\n\ndel {\n  text-decoration: line-through; }\n\nabbr[title], dfn[title] {\n  border-bottom: 1px dotted;\n  cursor: help; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\n/* change border colour to suit your needs */\nhr {\n  display: block;\n  height: 1px;\n  border: 0;\n  border-top: 1px solid #cccccc;\n  margin: 1em 0;\n  padding: 0; }\n\ninput, select {\n  vertical-align: middle; }\n\nbody {\n  background-image: radial-gradient(circle at 50% 50%, #006ac5 10%, #4eb5ff 120%); }\n\n.section-title {\n  font-size: 3em;\n  text-align: center;\n  margin-bottom: 0.75em; }\n\n.subtitle-container {\n  min-height: 3em;\n  text-align: center; }\n\n.col {\n  margin: 1em 0; }\n\nh2 {\n  font-size: 1.5em; }\n\nol > li {\n  padding-bottom: 0.5em;\n  padding-left: 1em;\n  font-size: 1.25em; }\n  ol > li:first-child {\n    padding-top: 2em; }\n\ntable.board {\n  margin: 0 auto; }\n\n#minesweeper {\n  font-family: 'Lobster', cursive;\n  padding: 1.5em 3em;\n  text-shadow: 0px 1px 0px #03325a;\n  color: white; }\n  #minesweeper table.board td {\n    background-color: white;\n    border-radius: 6px;\n    width: 48px;\n    height: 48px;\n    text-align: center;\n    vertical-align: middle;\n    font-size: 1.5em;\n    transition: background ease 0.15s;\n    user-select: none;\n    border: 3px solid transparent;\n    background-clip: padding-box; }\n    #minesweeper table.board td.mine {\n      background-image: url(" + __webpack_require__(12) + ");\n      background-size: contain;\n      background-size: 60%;\n      background-repeat: no-repeat;\n      background-position: center; }\n    #minesweeper table.board td.flag {\n      background-image: url(" + __webpack_require__(11) + ");\n      background-size: contain;\n      background-size: 50%;\n      background-repeat: no-repeat;\n      background-position: center; }\n    #minesweeper table.board td.question {\n      background-image: url(" + __webpack_require__(13) + ");\n      background-size: contain;\n      background-size: 30%;\n      background-repeat: no-repeat;\n      background-position: center; }\n    #minesweeper table.board td.revealed {\n      background-color: #4eb5ff; }\n    #minesweeper table.board td:hover {\n      cursor: pointer;\n      background-color: rgba(255, 255, 255, 0.8); }\n  #minesweeper .subtitle-container {\n    font-size: 1.25em; }\n    #minesweeper .subtitle-container .icon {\n      vertical-align: middle;\n      margin-right: 0.5em;\n      font-size: 2em; }\n    #minesweeper .subtitle-container .flag-counter-value {\n      display: inline-block;\n      min-width: 18px; }\n    #minesweeper .subtitle-container .timer-elapsed {\n      position: relative;\n      top: 2px; }\n  #minesweeper .new-game {\n    border: 2px solid white;\n    border-radius: 40px;\n    padding: 0.35em 1em;\n    margin: 0 2em;\n    width: 200px;\n    font-size: 1.25em;\n    transition: background ease 0.15s;\n    font-weight: bold; }\n    #minesweeper .new-game:hover {\n      cursor: pointer;\n      background-color: #4eb5ff; }\n", ""]);
...
module.exports = __webpack_require__.p + "f29d19722474d53429ac7f72343ff84b.svg";

/***/ }),
/* 12 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "21f365b9c1a6ed5f0c32884c159329f3.svg";

/***/ }),
/* 13 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "8ce86d4e232964c5b338f3003c9bac5b.svg";
